...
#import "HedgehogDiskImageSuccess.h"

@interface HedgehogDiskImageSuccess ()

@end

@implementation HedgehogDiskImageSuccess
...
- (IBAction)windows:(NSButton *)sender {
    [[NSWorkspace sharedWorkspace] openURL:[NSURL URLWithString:@"https://www.acutesystems.com/scrtm.htm"]];
}

- (IBAction)macos:(NSButton *)sender {
    [[NSWorkspace sharedWorkspace] launchApplication:@"/Applications/Utilities/Disk Utility.app"];
}

- (IBAction)linux:(NSButton *)sender {
    [[NSWorkspace sharedWorkspace] openURL:[NSURL URLWithString:@"https://github.com/datcuandrei/BackToMac"]];
}
